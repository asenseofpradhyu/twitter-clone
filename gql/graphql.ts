...
export type GetCurrentUserQuery = { __typename?: 'Query', getCurrentUser?: { __typename?: 'User', id: string, lastName?: string | null, email: string, firstName: string, profileImageURl?: string | null } | null };
